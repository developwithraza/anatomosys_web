...
import { AddPostComment, FilterAllComment, FollowUser, GiveLikePost, RemoveLikePost, ShareInnerRegularPost, UnFollow, userDetails } from '../../../services/api_services';
import ShowMoreText from "react-show-more-text";
import { LoadingOutlined } from '@ant-design/icons';
import { Link, useParams } from 'react-router-dom';
import { FetchAllSelectedUserRegularPosts } from '../../../services/api_services';
import TreandingRegularPost from '../../profile/TreandingRegularPost';
...
function SelectedUserRegularPost() {
    const {id}=useParams()
    ...
    const selectUserRegularPost = async () => {
        await FetchAllSelectedUserRegularPosts(postBody).then(res => {
            if (res.data.success) {
    ...
    return (
        <div className="container">
            <Row>
                <Col md={3}><SelectedUserProfile userId={id}/></Col>
                <Col md={6}>
                                    ...
                                    <Card key={post.PostID}>
                                        ...
                                        <div className="feed_post_design">
                                            ...
                                            <div className="more_option_follow">
                                                ...
                                                <SelectPostOption postData={post} selectUserRegularPost={selectUserRegularPost} UnSaveMessage={UnSaveMessage} saveMessage={saveMessage} />
                                            </div>
                                        </div>
...
export default SelectedUserRegularPost