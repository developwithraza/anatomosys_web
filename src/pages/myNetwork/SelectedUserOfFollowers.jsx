...
import { FollowUser, SelectedUserFollowers, SelectedUserFollowings, UnFollow, userDetails } from '../../services/api_services';
import NotImg from '../../assets/illustrat_Image/not_img.png'
import { useSelector } from 'react-redux';



function SelectedUserOfFollowers() {
    ...
    const SelectedUserFollowingList = async () => {
        await SelectedUserFollowers(SelecteduserBody).then(res => {
            if (res.data.success) {
...
export default SelectedUserOfFollowers
