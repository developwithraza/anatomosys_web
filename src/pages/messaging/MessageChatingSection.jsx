...
function MessageChatingSection({ chatRoomData, chatNow, selectedUser, ShowAllChatRoomList }) {
    ...
    return (
        <div className='chating_section' >
            ...
            <Scrollbar style={{ width: '100%', height: '50vh', padding: '0', margin: '0' }} ref={ref}>
                {allChats.length == 0 ? <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} /> : allChats.map((msg) => {
                    return (
                        <div className="store_message">
                            <div className={`${msg.USERID == userDetails.userID ? "send_message" : "recevied_message"}`} >
                        ...
                        <Col md={12}>
                            ...
                            >
                                <Input.TextArea
                                    ...
                                    placeholder='Write a Message...' onChange={(e) => setChatDec(e.target.value)} />
                            </Form.Item>
                        </Col>
...
export default MessageChatingSection
