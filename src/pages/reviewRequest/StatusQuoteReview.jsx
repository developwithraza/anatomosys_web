                    ...
                    <div className="request_review_details">
                        <Card>
                            ...
                            <div className="view_qoutes">
                                <Button type='primary' onClick={()=>navigate("/quote_reviewer_list")}>Public</Button>
                            </div>
                        </Card>
...
export default StatusQuoteReview
